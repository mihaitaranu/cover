...
<div id="content" class="filter-content">
    <!-- ############ Container ############ -->
    <div class="container clearfix <?php echo esc_attr( $releases_layout ) ?>">
    	...
    	<div class="grid-wrapper clearfix" data-grid="releases-grid">
            ...
            <div class="filters-wrapper filter-3 container clearfix">
                ...
                <!-- Filter -->
                <div class="filter" data-obj='{"action": "noisa_releases_filter", "filterby": "taxonomy", "cpt": "noisa_releases", "tax": "noisa_releases_artists", "limit": "<?php echo esc_attr( $limit ); ?>"}' >
                            ...
                            <ul data-filter-group="">
                                <li><a href="#" data-filter-name="all"><h3><?php echo esc_attr( __( 'All Artists', 'noisa' ) ) ?></h3></a></li>
                                    <?php 
                                        ...
                                        $terms = get_terms( 'noisa_releases_artists', $term_args );
                                        if ( $terms ) {
                ...
                <!-- Filter -->
                <div class="filter" data-obj='{"action": "noisa_releases_filter", "filterby": "taxonomy", "cpt": "noisa_releases", "tax": "noisa_releases_genres", "limit": "<?php echo esc_attr( $limit ); ?>"}' >
                    <div class="filter-dropdown">
                        <div class="filter-collpase-btn">
                            <h4 class="filter-title-anim"><?php echo esc_attr( __( 'Filter by', 'noisa' ) ) ?></h4>
                        ...
                        <div class="filter-dropdown-content">
                            <ul data-filter-group="">
                                <li><a href="#" data-filter-name="all"><h3><?php echo esc_attr( __( 'All Genres', 'noisa' ) ) ?></h3></a></li>
                                    <?php 
                                        $term_args = array( 'hide_empty' => '1', 'orderby' => 'name', 'order' => 'ASC' );
                                        $terms = get_terms( 'noisa_releases_genres', $term_args );
                                        if ( $terms ) {
                                            foreach ( $terms as $term ) {
                                                echo '<li><a href="#" data-filter-name="' . esc_attr( $term->term_id ) . '"><h3>' . $term->name . '</h3></a></li>';
                                            }
                ...
                <!-- Filter -->
                <div class="filter" data-obj='{"action": "noisa_releases_filter", "filterby": "taxonomy", "cpt": "noisa_releases", "tax": "noisa_releases_cats", "limit": "<?php echo esc_attr( $limit ); ?>"}' >
                    <div class="filter-dropdown">
                        <div class="filter-collpase-btn">
                            <h4 class="filter-title-anim"><?php echo esc_attr( __( 'Filter by', 'noisa' ) ) ?></h4>
                        ...
                        <div class="filter-dropdown-content">
                            <ul data-filter-group="">
                                <li><a href="#" data-filter-name="all"><h3><?php echo esc_attr( __( 'All Categories', 'noisa' ) ) ?></h3></a></li>
                                    <?php 
                                        $term_args = array( 'hide_empty' => '1', 'orderby' => 'name', 'order' => 'ASC' );
                                        $terms = get_terms( 'noisa_releases_cats', $term_args );
                                        if ( $terms ) {
                                            foreach ( $terms as $term ) {
                                                echo '<li><a href="#" data-filter-name="' . esc_attr( $term->term_id ) . '"><h3>' . $term->name . '</h3></a></li>';
                                            }
        	...
        	<div class="masonry <?php echo esc_attr( $gap ) ?> releases-grid masonry-anim clearfix">	
        		<?php
                ...
                <?php if ( has_post_thumbnail() ) : ?> 
                    <article <?php post_class( 'masonry-item masonry-item-1-3' ); ?>>
            			...
            			<div class="grid-media">        
                            ...
                            ?>
                            <a href="<?php echo esc_url( get_permalink() ) ?>" class="<?php echo esc_attr( $thumb_classes ) ?>">
