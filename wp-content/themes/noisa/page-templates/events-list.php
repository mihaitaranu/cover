    ...
    <div class="container clearfix <?php echo esc_attr( $events_layout ) ?> <?php echo esc_attr( $event_thumb_style ) ?>">
        ...
        <div class="grid-wrapper clearfix" data-grid="events-list">
            ...
            <div class="filters-wrapper filter-3 container clearfix">
                ...
                <!-- Filter -->
                <div class="filter" data-obj='{"action": "noisa_events_filter", "filterby": "taxonomy", "cpt": "noisa_events", "tax": "noisa_events_artists", "limit": "<?php echo esc_attr( $limit ); ?>", "event_type": "<?php echo esc_attr( $event_type ); ?>", "display_type": "list"}' >
                ...
                <!-- Filter -->
                <div class="filter" data-obj='{"action": "noisa_events_filter", "filterby": "taxonomy", "cpt": "noisa_events", "tax": "noisa_events_locations", "limit": "<?php echo esc_attr( $limit ); ?>", "event_type": "<?php echo esc_attr( $event_type ); ?>", "display_type": "list"}' >
                    <div class="filter-dropdown">
                        <div class="filter-collpase-btn">
                            <h4 class="filter-title-anim"><?php echo esc_attr( __( 'Filter by', 'noisa' ) ) ?></h4>
                ...
                <!-- Filter -->
                <div class="filter" data-obj='{"action": "noisa_events_filter", "filterby": "taxonomy", "cpt": "noisa_events", "tax": "noisa_events_cats", "limit": "<?php echo esc_attr( $limit ); ?>", "event_type": "<?php echo esc_attr( $event_type ); ?>", "display_type": "list"}' >
                    <div class="filter-dropdown">
                        <div class="filter-collpase-btn">
                            <h4 class="filter-title-anim"><?php echo esc_attr( __( 'Filter by', 'noisa' ) ) ?></h4>
            ...
            <div class="masonry masonry-list events-list masonry-anim clearfix">    
             ...
             <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
                    <article <?php post_class( 'masonry-item' ); ?>>
                        ...
                        <a href="<?php echo esc_url( get_permalink() ) ?>" class="event-li">
                            ...
                            <span class="date">
                                <?php 
                                    ...
                                    echo date_i18n( $date_format, $event_date_start );
                                    if ( has_term( 'past-events', 'noisa_event_type' ) ) {
                                        echo '<span class="past-event-label">' . __( 'Past Event', 'noisa' ) . '</span>';
                                    }    
                                ?>
                            </span>
                            <span class="venue">
