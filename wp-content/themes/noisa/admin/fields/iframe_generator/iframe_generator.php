	...
	class MuttleyPanel_iframe_generator extends MuttleyPanel {
        ...
        */
		public function render() {
			...
			echo '<button class="_button generate-iframe" style="' . $display_g . '"><i class="fa icon fa-magic"></i>' . __('Generate Iframe', 'noisa' ) . '</button>';
			
			echo '<button class="_button ui-button-delete delete-iframe" style="' . $display_d . '"><i class="fa icon fa-trash-o"></i>' . __('Remove', 'noisa' ) . '</button>';

			echo '<p class="msg msg-error" style="display:none;">' . __( 'Error: Content does not contain the iframe.', 'noisa' ) . '</p>';
		...
		private function widget() {
			...
			echo 
				...
				<label for="iframe-content">' . __( 'Iframe Code', 'noisa' ) . '
				</label>';
			echo '<textarea id="iframe-content" name="iframe_content"></textarea>';
			echo '<p class="help-box">' . __( 'Paste Iframe code here..', 'noisa' ) . '</p></div>';
			echo '</div>';
