...
if ( ! class_exists( 'MuttleyBox_date_range' ) ) {

	class MuttleyBox_date_range extends MuttleyBox {
        ...
        */
		public function render() {
			...
			echo '<input name="' . self::$_option['id'][0]['id'] . '" id="' . self::$_option['id'][0]['id'] . '" type="text" value="' . htmlspecialchars( self::$_option['id'][0]['std'] ) . '" class="datepicker-input"/>';
			echo '</div>';
			// End
			echo '<div class="input-group date-range-end">';
			echo '<span class="input-group-addon"><i class="fa fa-calendar"></i></span>';
			echo '<input name="' . self::$_option['id'][1]['id'] . '" id="' . self::$_option['id'][1]['id'] . '" type="text" value="' . htmlspecialchars( self::$_option['id'][1]['std'] ) . '" class="datepicker-input"/>';
			echo '</div>';
			echo '</div>';
